...
#. In Kompozer, switch to the Source view (clicking the Source tab).
...
Back in the Normal mode, add some formatting like italics, and an
extra line of text, and save the file again (under the *same*
...
embedded in the web page that is produced.
...
``main`` functions. You will also need the HTML for the page
